    ...
    <body>
      <table class="TablaEncabezado" border="0" width="100%" >
        ...
        <div class="container mregister">
            <div id="login">
                <h1>Registrar</h1>
                <form name="registerform" id="registerform" action="Registro_Usuario.php" method="post">
                    <p>
                    ...
                    <p>
                        <label for="user_pass">E-mail<br />
                            <input type="email" name="email" id="email" class="input" value="" size="32" title="Ingresa un correo electronico" /></label>
                    </p>
                    ...
                    <p>
                        <label for="user_pass">Contrase&ntilde;a<br />
                            <input type="password" name="password" id="password" class="input" value="" size="32" title="Ingresa una contrase&ntilde;a de al menos 6 caracteres" /></label>
                    </p>	
                    <p class="submit">
                        <input type="submit" name="register" id="register" class="button" value="Registrar" />
                    </p>
                    </p>
                    <p class="regtext"><a href="Login.php" > <h2>Inicio</h2></a></p>
                    </form>
                </form>
            </div>
        </div>
