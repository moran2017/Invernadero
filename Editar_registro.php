...
if (isset($_POST["editar"]))
{
    ...
    if (!empty($_POST['usuario']) && !empty($_POST['email']) &&  !empty($_POST['password']))
    {
        ...
        $resultadoConsulta = actualizarMSSQL($query);
        ...
        if ($numrows != 0)
        {
            $query = "UPDATE login SET email='$EMAIL',password='$PASSWORD' WHERE usuario='$USUARIO'";
        ...
        {
            $message = "El nombre de usuario no existe! Por favor, ingresa el correcto!";
        }
    } else
    {
...
.TablaEncabezado {
    ...
    <body>
        ...
        <div class="container meditar">
            <div id="login">
                <h1>Actualizar Usuario</h1>
                <form name="editarform" id="editarform" action="Editar_registro.php" method="post">
                    <p>
                    ...
                    <p class="submit">
                        <input type="submit" name="editar" id="editar" class="button" value="Actualizar" />
                    </p>
